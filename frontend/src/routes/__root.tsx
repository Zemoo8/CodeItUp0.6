...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Acorn AI" },
      { name: "description", content: "Acorn AI helps Sandy manage inventory, projects, and planning in one chat workspace." },
      { name: "author", content: "Acorn AI" },
      { property: "og:title", content: "Acorn AI" },
      { property: "og:description", content: "Acorn AI helps Sandy manage inventory, projects, and planning in one chat workspace." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Acorn AI" },
      { name: "twitter:description", content: "Acorn AI helps Sandy manage inventory, projects, and planning in one chat workspace." },
